namespace PicatBlazorMonaco.Pages;
...
public partial class Index : ComponentBase
{
    ...
    private async Task EditorOnDidInit()
    {
        ...
        this._astEditor = new Ast2Editor(_editor, _jsRuntime, Logger);
        await this._astEditor.Init();

        await _editor.AddAction(new ActionDescriptor
        {
            Id = "runSnippet",
            Label = "Run selected snippet",
            Keybindings = new[] { (int)KeyMod.CtrlCmd | (int)KeyCode.KeyR },
            ContextMenuGroupId = "_picat",
            ContextMenuOrder = 1,
            Run = async x =>
            {
