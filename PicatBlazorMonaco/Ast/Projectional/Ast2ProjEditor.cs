...
namespace Ast2
{
    public class Ast2ProjEditor
    {
        ...
        {
            await _monacoEditor.AddCommand((int)KeyMod.CtrlCmd | (int)KeyCode.Home, async (editor, keyCode) =>
            {
            ...
            await _monacoEditor.AddAction("suggest", "", new[] { (int)KeyMod.CtrlCmd | (int)KeyCode.Space }, "!suggestWidgetVisible", null, null, 0, async (editor, keyCode) =>
            {
            ...
            await _monacoEditor.AddCommand((int)KeyMod.CtrlCmd | (int)KeyCode.KeyX, async (editor, keyCode) =>
            {
                Console.WriteLine("CMD:" + keyCode);
            });

            await _monacoEditor.AddCommand((int)KeyMod.CtrlCmd | (int)KeyCode.KeyY, async (editor, keyCode) =>
            {
                Console.WriteLine("CMD:" + keyCode);
            });


            await _monacoEditor.AddCommand((int)KeyMod.Shift | (int)KeyCode.LeftArrow, async (editor, keyCode) =>
            {
            ...
            await _monacoEditor.AddCommand((int)KeyMod.Shift | (int)KeyCode.RightArrow, async (editor, keyCode) =>
            {
                using JsonDocument doc2 = JsonDocument.Parse(@"{}");
                JsonElement root2 = doc2.RootElement;
            ...
            await _monacoEditor.AddCommand((int)KeyMod.Shift | (int)KeyCode.UpArrow, async (editor, keyCode) =>
            {
                using JsonDocument doc2 = JsonDocument.Parse(@"{}");
                JsonElement root2 = doc2.RootElement;
            ...
            await _monacoEditor.AddCommand((int)KeyMod.Shift | (int)KeyCode.DownArrow, async (editor, keyCode) =>
            {
                using JsonDocument doc2 = JsonDocument.Parse(@"{}");
                JsonElement root2 = doc2.RootElement;
            ...
            await _monacoEditor.AddCommand((int)KeyMod.CtrlCmd | (int)KeyCode.KeyZ, async (editor, keyCode) =>
            {
                Console.WriteLine("CMD:" + keyCode);
        ...
        public async Task OnTextTyped(ModelContentChangedEvent eventArg)
        {
            ...
            ConsoleLog("OnTextTyped: " + eventArg.Changes[0]?.Text);
        ...
        {
            await _monacoEditor.SetPosition(position, "posss");
